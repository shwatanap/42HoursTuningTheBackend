...
const allActive = async (req, res) => {
  ...
  const searchRecordQs = `select title, application_group, created_by, created_at, updated_at from record where status = "open" order by updated_at desc, record_id asc limit ? offset ?`;
